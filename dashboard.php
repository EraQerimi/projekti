    ...
    <section id="registration">
        ...
        <div class="form">
            <form action="../controller/userController.php" id="formff">
                ...
                <div class="btn">
                    <input class="yellow" type="submit" name='registerUser' id="signupForm">Sign Up</button>
                </div>
            </form>
        </div>
        <div class="form">
            <form action="../controller/userController.php">
                ...
                <div class="btn">
                    <input class="yellow" type="submit" name='loginUser'id="loginForm">Log In</button>
                </div>
            </form>
        </div>
    </section>
...
<!-- Validimii -->
  ...
  var login = document.getElementById("formff");
  ...
  login.addEventListener("submit",function(event) {
      ...
      var surnameLabel= document.getElementById('lasNameLabel');
